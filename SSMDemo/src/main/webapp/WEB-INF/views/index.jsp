                    ...
                    <div class="row card-panel">
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="userid" type="text"  name="id" class="validate"  data-rule-minlength="10"  data-rule-maxlength="10"  required>
                        ...
                        <div class="row" style="text-align: center;color: rebeccapurple">${errormessage}</div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s6 offset-s6">
                                <p class="margin right-align medium-small"><a href="/reset_pass/input_account.html">忘记密码?</a></p>
                            </div>
                        </div>
                    </div>
                </form>
